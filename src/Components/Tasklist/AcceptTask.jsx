...
const AcceptTask = ({data}) => {
  return (
    <div className="bg-pink-600  flex-shrink-0 h-52 w-72 rounded-lg  p-5 text-white flex-nowrap ">
    ...
    <button className='py-1 text-sm mt-2 rounded mx-auto bg-green-400'>Accept Task</button>
  </div>
  )
}
